...
export const AdminCenter = () => {
  return (
    <NavigationLayout title="Administración del Software SST - NewStetic">
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-gray-600 text-lg leading-relaxed max-w-2xl">
                Gestiona y configura todos los aspectos del sistema SST desde un
                solo lugar.
                <span className="text-gray-500">
                  {" "}
                  Accede a las herramientas de configuración y control.
                </span>
              </p>
            </div>
      ...
      {/* Cards Grid */}
      <motion.div
        className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pb-5"
